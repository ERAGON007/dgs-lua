...
export class LuaClass {
    ...
    toMarkdown(): vscode.MarkdownString {
        let result = new vscode.MarkdownString();
        result.appendCodeblock(this.label, "luamtatypes");
        result.appendMarkdown(this.description + "\n\n");
        return result;
    }
}
